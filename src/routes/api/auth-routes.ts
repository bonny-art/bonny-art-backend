import { loginSchema, registerSchema, updateUserSchema } from '../../db/models/User.js';
...
authRouter.patch('/update', authenticate, validateBody(updateUserSchema), authController.updateUser);
